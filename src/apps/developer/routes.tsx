...
/* layout */
const AdminLayOut = lazy(() => import("./layout/DeveloperLayout"));
...
const SchoolList = lazy(() => import("./pages/SchoolListing/SchoolList"));
const RegisterSchool = lazy(
  () => import("./pages/SchoolListing/RegisterSchool"),
);
const AddEditPlan = lazy(() => import("./pages/Profile/AddEditPlan"));
const PlanList = lazy(() => import("./pages/PlanList/PlanList"));
        ...
        children: [
          {
            ...
            element: (
              <PermissionRoute
                permission={developerPermission?.dashboard?.read}
              >
                <AdminDashboard />
              </PermissionRoute>
            ),
          ...
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={developerPermission?.admin_user?.read}
              >
                <AdminUser />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={developerPermission?.admin_user?.create}
              >
                <AddEditAdminUser />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={developerPermission?.admin_user?.update}
              >
                <AddEditAdminUser />
              </PermissionRoute>
            ),
          ...
          },
          {
            path: "/transactions",
            element: (
              <PermissionRoute permission={developerPermission?.transaction?.read}>
                <TransactionsList />
              </PermissionRoute>
            ),
          },
