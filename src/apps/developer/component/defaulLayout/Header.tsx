          ...
          <Box className="admin-header-drop-main">
            ...
            >
              ...
              >
                ...
                <ExpandMore
                  style={{ color: "rgba(255,255,255,0.7)", fontSize: "20px" }}
                />
              </Box>
            </Button>
          </Box>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                <img
                  ...
                  style={{
                    ...
                    height: "18px",
                    filter:
                      "brightness(0) saturate(100%) invert(8%) sepia(87%) saturate(3065%) hue-rotate(200deg) brightness(92%) contrast(106%)",
                  }}
                  alt="Settings"
                />
                Account Settings
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                <img
                  ...
                  style={{
                    ...
                    height: "18px",
                    filter:
                      "brightness(0) saturate(100%) invert(20%) sepia(90%) saturate(3000%) hue-rotate(345deg) brightness(95%) contrast(105%)",
                  }}
                  alt="Logout"
                />
                Logout
