                            ...
                            <Form>
                                ...
                                <TableContainer component={Paper} className="table-container permission-table-container" sx={{ boxShadow: 'none', border: '1px solid #e0e0e0', borderRadius: '12px' }}>
                                    <Table className="table">
                                        <TableHead className="table-head" sx={{ bgcolor: '#f8fbfc' }}>
                                        ...
                                        <TableBody className="table-body">
                                            ...
                                            {roleStaticData.map((module) => (
                                                <TableRow key={module.mainTitleId} className="table-row" sx={{ '&:hover': { bgcolor: '#f5f5f5' } }}>
                                                    <TableCell className="table-td" sx={{ py: 2 }}>{module.mainTitle}</TableCell>
