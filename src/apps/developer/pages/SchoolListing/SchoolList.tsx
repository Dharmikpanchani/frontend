            ...
            <Table aria-label="simple table" className="table">
              <TableHead className="table-head">
                <TableRow className="table-row">
                  <TableCell className="table-th" width="16%">
                    SCHOOL DETAILS
                  </TableCell>
                  <TableCell className="table-th" width="16%">
                    LOCATION
                  ...
                  <TableCell className="table-th" width="14%">
                    JOINED
                  </TableCell>
                  {hasAnyPermission([
                    ...
                    <TableCell className="table-th" width="10%" align="center">
                      ACTIONS
                    </TableCell>
                  )}
                </TableRow>
              ...
              <TableBody className="table-body">
                {!loading ? (
                  schools?.length ? (
                      ...
                      >
                          ...
                          >
                            ...
                            <Box>
                              ...
                              >
                                <Box
                                  onClick={() =>
                                    handleCopyCode(data?._id, data?.schoolCode)
                                  }
                                  sx={{
                                    display: "flex",
                                    alignItems: "center",
                        ...
                        <TableCell className="table-td">
                          ...
                          >
                            ...
                            {hasPermission(
                              developerPermission.school.status,
                            ) && (
                              <Box
                    ...
                    <DataNotFound text="No Schools Found" />
                  )
                ) : (
                  <Loader
                    colSpan={
