...
export default function RegisterSchool() {
  ...
  const { selectedSchool, actionLoading, loading } = useSelector(
  ...
  const initialValues = useMemo(
    () => ({
      ...
      affiliationCertificateUrl:
        isEdit || isView ? selectedSchool?.affiliationCertificate || "" : "",
      // Branding
      logo: null,
    ...
    try {
      ...
      if (addEditSchool.fulfilled.match(resultAction)) {
        if (isEdit) {
          ...
          navigate("/school-register/otp", {
            state: { type: "schoolRegistration", email: values.email },
          });
        }
      }
    } catch (error: any) {
              ...
              return (
                <Form onSubmit={handleSubmit}>
                  <Box sx={{ maxWidth: 1100 }}>
                    ...
                    >
                      ...
                      <Box gridColumn={{ xs: "span 12", sm: "span 6" }}>
                        ...
                        <TextField
                          ...
                          onBlur={handleBlur}
                          error={
                            touched.schoolCode && Boolean(errors.schoolCode)
                          }
                        ...
                        <Autocomplete
                          ...
                          renderInput={(params) => (
                            <TextField
                              ...
                              sx={inputSx}
                              error={
                                touched.schoolType && Boolean(errors.schoolType)
                              }
                            />
                          )}
                          sx={{
                      ...
                      <Box
                        gridColumn={{
                          xs: "span 12",
                          sm: isEdit || isView ? "span 4" : "span 6",
                        }}
                      >
                        <Typography sx={labelSx}>
                          {isEdit || isView
                    ...
                    <SectionTitle
                      icon={LegalIcon}
                      title="Legal / Verification Details"
                    />
                    <Box
                      display="grid"
                      gridTemplateColumns="repeat(12, 1fr)"
                    ...
                    >
                      ...
                      <Box gridColumn={{ xs: "span 12", sm: "span 6" }}>
                        ...
                        >
                          ...
                          >
                            <strong>Recommended:</strong> 1200x400px (3:1
                            Ratio).
                            <br />
                            Max 20MB. JPG, PNG, SVG.
                          </Typography>
