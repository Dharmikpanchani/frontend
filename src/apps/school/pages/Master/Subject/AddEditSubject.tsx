  ...
  useEffect(() => {
    if (id && selectedSubject && (isEdit || isView)) {
      setInitialValues({
        ...
        departmentIds:
          selectedSubject.departmentIds?.map((d: any) => d._id || d) || [],
      });
    }
                  ...
                  >
                    ...
                    <Box gridColumn="span 12">
                      ...
                      <Autocomplete
                        ...
                        value={
                          departments?.filter((d: any) =>
                            values.departmentIds.includes(d._id),
                          ) || []
                        }
                        onChange={(_, v) =>
                          setFieldValue(
                        ...
                        renderInput={(p) => (
                          <TextField
                            {...p}
                            placeholder={isView ? "" : "Select Departments"}
                            variant="outlined"
                            sx={multiInputSx}
                            error={
                              touched.departmentIds &&
                              Boolean(errors.departmentIds)
                            }
                          />
                        )}
                      />
                      {touched.departmentIds && errors.departmentIds && (
                        <FormHelperText className="error-text">
                          {errors.departmentIds as string}
                        </FormHelperText>
                      )}
                    </Box>
                  </Box>
