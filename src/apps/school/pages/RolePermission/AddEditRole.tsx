...
import {
  ...
  schoolRoleStaticData as roleStaticData,
...
export default function AddEditRole() {
  ...
  const isMasterAllChecked = () => {
    const masterModules = roleStaticData.filter((m) =>
  ...
  const isAdminAllChecked = () => {
    const adminModules = roleStaticData.filter((m) =>
                ...
                >
                  <Table className="table">
                    <TableHead
                      ...
                      sx={{ bgcolor: "var(--table-header-bg, #f8fbfc)" }}
                    >
                            ...
                            >
                              ...
                              <TableCell className="table-td" align="center">
                                <BpCheckbox
                                  ...
                                  onChange={(e: any) =>
                                    handleAdminAllChange(e.target.checked)
                                  }
                                  disabled={isView}
                                />
                              </TableCell>
                            ...
                            >
                              ...
                              <TableCell className="table-td" align="center">
                                <BpCheckbox
                                  ...
                                  onChange={(e: any) =>
                                    handleMasterAllChange(e.target.checked)
                                  }
                                  disabled={isView}
                                />
                              </TableCell>
                        ...
                        rows.push(
                          <TableRow
                            ...
                            sx={{
                              ...
                              bgcolor:
                                isMaster || isAdmin ? "#fcfcfc" : "inherit",
                            }}
                          >
                            <TableCell
                              className="table-td"
                              sx={{ py: 2, pl: isMaster || isAdmin ? 5 : 2 }}
                            >
                              {(isMaster || isAdmin) && (
                                <span
                ...
                >
                  ...
                  {!isView && (
                    <Button
                      ...
                      variant="contained"
                      startIcon={
                        !buttonSpinner ? id ? <EditIcon /> : <AddIcon /> : null
                      }
                      sx={{
                        minWidth: "120px",
                        borderRadius: "8px",
