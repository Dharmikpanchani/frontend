              ...
              <Box className="admin-search-main">
                <Box className="admin-search-box">
                  <Box className="admin-form-group">
                    ...
                    <img
                      src={Svg.search}
                      className="school-admin-search-grey-img admin-icon admin-icon-theme"
                      alt="search"
                    />
                  </Box>
                </Box>
                ...
                <Table aria-label="simple table" className="table">
                  <TableHead className="table-head">
                    <TableRow className="table-row">
                      <TableCell className="table-th" width="22%">
                        SCHOOL DETAILS
                      </TableCell>
                      ...
                      <TableCell className="table-th" width="13%">
                        TAX INFO
                      </TableCell>
