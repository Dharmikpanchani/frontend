...
/* layout */
const AdminLayOut = lazy(() => import("./layout/SchoolLayout"));
const AdminDashboard = lazy(() => import("./pages/Dashboard"));
const Profile = lazy(() => import("./pages/Profile/AccountLayout"));
const RoleList = lazy(() => import("./pages/RolePermission/RolePermission"));
const AddEditRole = lazy(() => import("./pages/RolePermission/AddEditRole"));
const AdminUser = lazy(() => import("./pages/AdminUser/AdminUser"));
const AddEditAdminUser = lazy(
  () => import("./pages/AdminUser/AddEditAdminUser"),
);
const ThemeSettings = lazy(() => import("./pages/Profile/ThemeSettings"));
const UserPlan = lazy(() => import("./pages/UserPlan/UserPlan"));

/* master */
const DepartmentList = lazy(
  () => import("./pages/Master/Department/Department"),
);
const AddEditDepartment = lazy(
  () => import("./pages/Master/Department/AddEditDepartment"),
);
const SubjectList = lazy(() => import("./pages/Master/Subject/Subject"));
const AddEditSubject = lazy(
  () => import("./pages/Master/Subject/AddEditSubject"),
);
...
const AddEditSection = lazy(
  () => import("./pages/Master/Section/AddEditSection"),
);
...
function PermissionRoute({
  ...
  return hasPermission(permission) ? <>{children}</> : <NotAllowPermission />;
}
        ...
        children: [
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.dashboard?.read}
              >
                <AdminDashboard />
              </PermissionRoute>
            ),
          ...
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.admin_user?.read}
              >
                <AdminUser />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.admin_user?.create}
              >
                <AddEditAdminUser />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.admin_user?.update}
              >
                <AddEditAdminUser />
              </PermissionRoute>
            ),
          ...
          // Department
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.department?.read}
              >
                <DepartmentList />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.department?.create}
              >
                <AddEditDepartment />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.department?.update}
              >
                <AddEditDepartment />
              </PermissionRoute>
            ),
          ...
          // Subject
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.subject?.read}
              >
                <SubjectList />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.subject?.create}
              >
                <AddEditSubject />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.subject?.update}
              >
                <AddEditSubject />
              </PermissionRoute>
            ),
          ...
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.class?.create}
              >
                <AddEditClass />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.class?.update}
              >
                <AddEditClass />
              </PermissionRoute>
            ),
          ...
          // Section
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.section?.read}
              >
                <SectionList />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.section?.create}
              >
                <AddEditSection />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.section?.update}
              >
                <AddEditSection />
              </PermissionRoute>
            ),
          ...
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.teacher?.create}
              >
                <AddEditTeacher />
              </PermissionRoute>
            ),
          },
          {
            ...
            element: (
              <PermissionRoute
                permission={schoolAdminPermission?.teacher?.update}
              >
                <AddEditTeacher />
              </PermissionRoute>
            ),
